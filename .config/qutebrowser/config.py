...
FONT = "12pt default_family"
START_PAGE = "https://searx.be/"
SEARCH_ENGINES = {
...
for pattern in ENABLE_JAVASCRIPT_FOR:
...
config.bind("<Ctrl-l>", "spawn dmenu-handle-link {url}")
